-- default leader keys (<SPACE>)
vim.g.mapleader = ' '
vim.g.maplocalleader = ' '

-- ensure operations do not overwrite register content
...
vim.keymap.set({'n', 'v'}, '<C-t>', '<CMD>enew<CR>', { desc='New empty buffer', noremap = true, silent=true })
vim.keymap.set({'n', 'v'}, '<C-q>', '<CMD>bdelete<CR>', { desc='Delete current buffer', noremap = true, silent=true })
-- vim.keymap.set({'n', 'v'}, '<leader>1', '<CMD>b1<CR>', { desc='Go to tab #1', noremap=true, silent=true })
-- vim.keymap.set({'n', 'v'}, '<leader>2', '<CMD>b2<CR>', { desc='Go to tab #2', noremap=true, silent=true })
-- vim.keymap.set({'n', 'v'}, '<leader>3', '<CMD>b3<CR>', { desc='Go to tab #3', noremap=true, silent=true })
-- vim.keymap.set({'n', 'v'}, '<leader>4', '<CMD>b4<CR>', { desc='Go to tab #4', noremap=true, silent=true })
-- vim.keymap.set({'n', 'v'}, '<leader>5', '<CMD>b5<CR>', { desc='Go to tab #5', noremap=true, silent=true })
-- vim.keymap.set({'n', 'v'}, '<leader>6', '<CMD>b6<CR>', { desc='Go to tab #6', noremap=true, silent=true })
-- vim.keymap.set({'n', 'v'}, '<leader>7', '<CMD>b7<CR>', { desc='Go to tab #7', noremap=true, silent=true })
-- vim.keymap.set({'n', 'v'}, '<leader>8', '<CMD>b8<CR>', { desc='Go to tab #8', noremap=true, silent=true })
-- vim.keymap.set({'n', 'v'}, '<leader>9', '<CMD>b9<CR>', { desc='Go to tab #9', noremap=true, silent=true })
...
-- vim.keymap.set({'n', 'v'}, '<leader>n', '<CMD>tabnext<CR>', { desc='Go to next tab', noremap=true, silent=true })
-- vim.keymap.set({'n', 'v'}, '<leader>p', '<CMD>tabprevious<CR>', { desc='Go to previous tab', noremap=true, silent=true })
...
-- move highlighted chunks (from @ThePrimeagen)
...
vim.keymap.set({'n', 'v'}, 'QA', '<CMD>qa!<CR>', { noremap=true, silent=true })
vim.keymap.set({'n', 'v'}, 'WW', '<CMD>wa<CR>', { noremap=true, silent=true })
